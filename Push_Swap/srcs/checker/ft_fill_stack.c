...
/*   Updated: 2021/04/29 10:02:32 by Jules            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (!(all->stA.stack = malloc(sizeof(int) * all->stA.len + 1)))
        ;
    if (!(all->stB.stack = malloc(sizeof(int) * all->stA.len + 1)))
        ;
    if (!(all->stA.stack_aff = malloc(sizeof(char *) * all->stA.len + 1)))
        ;
    if (!(all->stB.stack_aff = malloc(sizeof(char *) * all->stA.len + 1)))
        ;
    ft_zero_stack(all);
}
